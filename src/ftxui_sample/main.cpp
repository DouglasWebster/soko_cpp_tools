...
// configuration step. It creates a namespace called `soko_cpp_tools`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", soko_cpp_tools::cmake::project_name, soko_cpp_tools::cmake::project_version) };
